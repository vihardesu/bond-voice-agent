...
export type Level4DraftSettings = {
...
export const DEFAULT_DRAFT_SETTINGS: Level4DraftSettings = {
  variantLabel: "alpha",
  ...
  llm: "qwen36-35b-a3b",
  interruptionMode: "protect_tools",
  personaPreset: "sam",
  promptProfile: "warm_empathetic",
  enabledTools: [...TOOL_OPTIONS],
  displayName: "Daphne v2",
  systemPrompt: "",
  firstMessage: "Hi, I'm Daphne. I'm your personal health concierge. How can I help?",
  asrKeywordsText: "medication, pharmacy, Walgreens, CVS, refill, symptom, follow-up",
  interruptionIgnoreTermsText: "uh huh, uh-huh, mm hmm, mm-hmm, mhm, gotcha, got it, okay, ok, yeah, yep, right, understood",
